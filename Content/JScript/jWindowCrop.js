(function ($) {
    ...
    $.jWindowCrop = function (image, options) {
        ...
        base.$image = $(image);
        base.image = image;
        base.$image.data("jWindowCrop", base);
        ...
        base.init = function () {
            ...
            base.$image.addClass("jwc_image").wrap("<div class='jwc_frame' />");
        ...
        base.destroy = function () {
            base.$image.removeData("jWindowCrop");
            $(document).unbind();
            base.$image.unbind();
            base.$frame.unbind();
            base.$frame.find(".jwc_zoom_out").unbind();
            base.$frame.find(".jwc_zoom_in").unbind();
            $(".jwc_loader").remove();
            $(".jwc_controls").remove();
            base.$image.removeAttr("style"); 
            base.$image.unwrap();
        };
        ...
        function handleMouseDown(event) {
            ...
            base.dragMouseCoords = {
                x: event.pageX,
                y: event.pageY
            };
            base.dragImageCoords = {
                x: parseInt(base.$image.css("left")),
                y: parseInt(base.$image.css("top"))
            };
        }
        ...
        function handleMouseEnter() {
            if (base.options.smartControls)
                base.$frame.find(".jwc_controls").fadeIn("fast");
        }

        function handleMouseLeave() {
            if (base.options.smartControls)
                base.$frame.find(".jwc_controls").fadeOut("fast");
        }
